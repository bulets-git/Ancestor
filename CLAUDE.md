...
This project is indexed by GitNexus as **AncestorTree** (3605 symbols, 6948 relationships, 290 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/AncestorTree/context` | Codebase overview, check index freshness |
| `gitnexus://repo/AncestorTree/clusters` | All functional areas |
| `gitnexus://repo/AncestorTree/processes` | All execution flows |
| `gitnexus://repo/AncestorTree/process/{name}` | Step-by-step execution trace |
